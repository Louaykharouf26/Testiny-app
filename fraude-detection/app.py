        ...
        if not success:
           ...
           # if len(sr.Microphone.list_microphone_names()):
            ...
            if  conditions[1]=="-One Person detected ✅" and conditions[2]=="-Face detected ✅" and conditions[3]=="-No phones ✅" and conditions[0]=="-Camera ✅" :
                ...
                conditions[5]="window.location.href='http://localhost:3001/js_quizz'"
                conditions[6]="window.location.href='http://localhost:3001/html_quiz'"
                conditions[7]="window.location.href='http://localhost:3001/css_quiz'"
            else:
