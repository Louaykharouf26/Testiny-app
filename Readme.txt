...
The fraude detection system should verify if there is another person with the developer or there is a phone and it can't redirect to the test only if there is just one person and no phones and also a clear environment where the developer is staying
